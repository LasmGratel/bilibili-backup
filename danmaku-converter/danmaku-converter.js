...
exports.DanmakuConverter = exports.DanmakuStack = exports.AssDanmakuDocument = exports.AssDanmaku = exports.DanmakuType = exports.XmlDanmakuDocument = exports.XmlDanmaku = exports.Danmaku = void 0;
class Danmaku {
...
class DanmakuConverter {
    constructor({ title, font, alpha, duration, blockTypes, blockFilter, resolution, bottomMarginPercent, bold }) {
        this.title = title;
        this.font = font;
    ...
    xmlDanmakuToAssDocument(xmlDanmakus) {
        const assDanmakus = [];
        ...
        return new AssDanmakuDocument(assDanmakus, this.title, this.fontStyles, this.blockTypes, this.resolution);
    }
    xmlStringToAssDocument(xml) {
