...
const decode = async (type: string, blob: Buffer) => {
...
export const decodeDanmakuSegment = (blob: Buffer) => decode('DmSegMobileReply', blob)
export const decodeDanmakuView = (blob: Buffer) => decode('DmWebViewReply', blob)
export default {
  export: {
    proto,
